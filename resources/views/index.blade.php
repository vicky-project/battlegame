...
<script>
  ...
  */
  ...
  setAppContent(`
  ${renderHeader(null)}
  <div class="d-flex align-items-center mb-3"><div style="font-size:48px;margin-right:12px;">😊</div><div><h2 class="h5 mb-0">Selamat datang, ${state.heroes.user?.first_name || 'Petarung'}!</h2><span class="badge bg-secondary">Lv. ${levelLabel}</span></div></div>
